...
if (yourPin.pin === myPin) {
    ...
    if (atmOption.option === "Withdraw") {
        ...
        if (amountAns.amount <= myBalance) {
            console.log(`withdrawal successfull! Now your remaining balance is : ${remainingBalance}`);
        }
        else {
        ...
        if (selectedAmount === "1000" ||
            ...
            console.log(`Fast cash withdrawal successful! Now your remaining balance is : ${myBalance}`);
        }
        else {
